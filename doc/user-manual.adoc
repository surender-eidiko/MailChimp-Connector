...
*Release Notes:* link:/release-notes/MailChimpReleaseNotes.adoc[Link to Release Notes]
...
5. Drag MailChimp connector into sparkroomcreateapplication flow.
...
|			|Token  | OAUTH c8fdd80cd9b36ebb948f356fcbd4bc80
|			|count  | None
			|apikey  | None
|===
...
4. Add a MailChimpConnector to your muleflow after the http endpoint according to the table below
		<mailchimp:get-authorized-apps config-ref="Mailchimp__Configuration" token="OAUTH c8fdd80cd9b36ebb948f356fcbd4bc80" doc:name="Mailchimp"/>
|===
|Attribute|Value
...
<mule xmlns:http="http://www.mulesoft.org/schema/mule/http" xmlns:json="http://www.mulesoft.org/schema/mule/json" xmlns:mailchimp="http://www.mulesoft.org/schema/mule/mailchimp" xmlns="http://www.mulesoft.org/schema/mule/core" xmlns:doc="http://www.mulesoft.org/schema/mule/documentation"
